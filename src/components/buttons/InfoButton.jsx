 ...
 * This button has a blue background and white text by default.
 * When hovered, the button has a light blue background and light grey text.
 */
...
const InfoButton = ({ children, className, path, ...props }) => {
  ...
  return (
    <BaseButton
      ...
      style={{
        background: isHovered ? SecondaryColor.light_blue : PrimaryColor.blue,
